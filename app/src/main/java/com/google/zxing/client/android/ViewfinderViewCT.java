 ...
 */
public final class ViewfinderViewCT extends View {
  ...
  public ViewfinderViewCT(Context context, AttributeSet attrs) {
    super(context, attrs);
...
/*    maskColor = Color.parseColor("#b0000000");
  ...
  public void setCameraManager(CameraManagerCT cameraManager) {
