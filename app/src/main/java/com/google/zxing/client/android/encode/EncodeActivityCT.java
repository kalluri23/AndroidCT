 ...
 */
public final class EncodeActivityCT extends Activity {

  private static final String TAG = EncodeActivityCT.class.getSimpleName();
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    menuInflater.inflate(com.google.zxing.client.android.R.menu.encode, menu);
    boolean useVcard = qrCodeEncoder != null && qrCodeEncoder.isUseVCard();
    int encodeNameResource = useVcard ? com.google.zxing.client.android.R.string.menu_encode_mecard : com.google.zxing.client.android.R.string.menu_encode_vcard;
    MenuItem encodeItem = menu.findItem(com.google.zxing.client.android.R.id.menu_encode);
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    switch (item.getItemId()) {
      case com.google.zxing.client.android.R.id.menu_share:
        share();
        return true;
      case com.google.zxing.client.android.R.id.menu_encode:
        Intent intent = getIntent();
        if (intent == null) {
          return false;
        }
  ...
  private void share() {
    ...
    File bsRoot = new File(Environment.getExternalStorageDirectory(), "BarcodeScannerCT");
    ...
    intent.putExtra(Intent.EXTRA_SUBJECT, getString(com.google.zxing.client.android.R.string.app_name) + " - " + encoder.getTitle());
  ...
  protected void onResume() {
    ...
    try {
      ...
      ImageView view = (ImageView) findViewById(com.google.zxing.client.android.R.id.image_view);
      view.setImageBitmap(bitmap);

      TextView contents = (TextView) findViewById(com.google.zxing.client.android.R.id.contents_text_view);
