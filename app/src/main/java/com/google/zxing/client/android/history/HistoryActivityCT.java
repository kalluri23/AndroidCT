...
public final class HistoryActivityCT extends ListActivity {

  private static final String TAG = HistoryActivityCT.class.getSimpleName();
  ...
  protected void onListItemClick(ListView l, View v, int position, long id) {
    if (adapter.getItem(position).getResult() != null) {
      Intent intent = new Intent(this, CaptureActivityCT.class);
