...
public class CTSubHeaderTextView extends TextView {

	public static Typeface FONT_NAME;
	// Font path
	private String fontPath = "fonts/NHaasGroteskDSStd-75Bd.otf";

	public CTSubHeaderTextView(Context context) {
		super(context);
		initMainHeaderTextView( context );
	}

	public CTSubHeaderTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initMainHeaderTextView( context );
	}

	public CTSubHeaderTextView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initMainHeaderTextView(Context context) {
		...
		//this.setTextSize( getResources().getDimension( R.dimen.ct_mf_black_header_font ) );
	}
}
