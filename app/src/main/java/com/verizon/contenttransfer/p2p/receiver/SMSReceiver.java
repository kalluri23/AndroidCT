...
public class SMSReceiver {
    ...
    private static String stausMessage = "none";

    public static void receiveSMS(Socket iosServerSocket) {
        String mediaType = "";
        try {
            ...
            clientOutputStream.write(VZTransferConstants.SMS_REQUEST_HEADER.getBytes());
            ...
            String FILE_NAME = VZTransferConstants.CLIENT_SMS_LIST_FILE;        //"contacts";
            ...
            try {
                ...
                int readSize = 0;
                DataSpeedAnalyzer.setProgressbarProperties(CTGlobal.getInstance().getContentTransferContext().getString(R.string.messages_str), VZTransferConstants.CLIENT_SMS_LIST_FILE);
                if (imageSize > 0) {
