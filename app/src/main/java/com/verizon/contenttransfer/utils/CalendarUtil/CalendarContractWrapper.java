...
//        }
    ...
    public static final class CalendarAlerts implements BaseColumns,
        ...
        public static void scheduleAlarm(Context context, AlarmManager manager, long alarmTime) {
            ...
            intent.setData(ContentUris.withAppendedId(com.verizon.contenttransfer.utils.CalendarUtil.CalendarContractWrapper.CONTENT_URI, alarmTime));
    ...
    public static final class SyncState implements SyncStateContract.Columns {
         ...
         */
        public static final Uri CONTENT_URI =
                Uri.withAppendedPath(com.verizon.contenttransfer.utils.CalendarUtil.CalendarContractWrapper.CONTENT_URI, CONTENT_DIRECTORY);
